...
#[inline(always)]
pub fn load_halfword(mmu: &mut crate::gba::mmu::Mmu, addr: u32) -> u32 {
    let val = mmu.cpu_read16(addr & !1) as u32;
...
#[inline(always)]
pub fn load_signed_halfword(mmu: &mut crate::gba::mmu::Mmu, addr: u32) -> u32 {
    if addr & 1 != 0 {
        mmu.cpu_read8(addr) as i8 as i32 as u32
    } else {
        mmu.cpu_read16(addr) as i16 as i32 as u32
    }
}
